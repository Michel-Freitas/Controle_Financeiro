    <h3 class="titulos"> Relatórios de Recebimentos </h3>
    <hr class="linha-topo">
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-5 relatorios">
                <form action="" method="get">
                    ...
                    <button type="submit" name="gerarRelatioRecebimentos" class="btn btn-primary" value="periodo">Gerar Relatório</button>
                </form>
            </div>
            <div class="col-md-5 relatorios">
                <form action="" method="get">
                    ...
                    <button type="submit" name="gerarRelatioRecebimentos" class="btn btn-primary" value="processamento">Gerar Relatório</button>
                </form>
            </div>
        </div>
    </div>